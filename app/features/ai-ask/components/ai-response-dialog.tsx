...
export function AIResponseDialog({
  ...
  return (
    <Dialog onOpenChange={onOpenChange} open={open}>
      <DialogContent className="top-0 left-0 flex h-[100dvh] w-screen max-w-none translate-x-0 translate-y-0 flex-col gap-0 overflow-hidden rounded-none border-0 bg-background/90 p-0 backdrop-blur-sm md:top-1/2 md:left-1/2 md:h-auto md:max-h-[85vh] md:min-h-[75vh] md:w-auto md:min-w-[80vw] md:max-w-none md:translate-x-[-50%] md:translate-y-[-50%] md:flex-row md:rounded-3xl md:border md:bg-background/70 md:backdrop-blur lg:max-h-[80vh] lg:min-h-[80vh]">
        <ChatSidebar
        ...
        <div className="flex flex-1 flex-col overflow-hidden">
          <DialogHeader className="flex flex-col gap-3 border-border/70 border-b px-4 py-3 text-center sm:px-6 sm:py-4 md:text-left">
          ...
          <DialogFooter className="border-border/70 border-t bg-background/90 px-4 pt-3 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] sm:px-6 sm:pt-4 sm:pb-4">
            {threadId ? (
