...
export const Message: React.FC<MessageProps> = (props) => {
  ...
  return (
    <div className={cn('group relative mb-6 px-4', className)}>
      <div
        className={cn(
          'mx-auto flex w-full max-w-4xl items-start gap-3 md:gap-4',
          isUser
            ? 'flex-row-reverse items-end justify-end text-right'
            : 'justify-start'
        )}
      >
        ...
        <div className={cn('min-w-0 flex-1', isUser ? 'sm:max-w-[75%]' : '')}>
          ...
          >
            ...
            {visibleText && (
              <div className={cn('p-4 text-sm leading-relaxed')}>
        ...
        {isUser && (
          <Avatar className="mt-1 h-8 w-8 flex-shrink-0 bg-purple-500 ring-2 ring-purple-100">
