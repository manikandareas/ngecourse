 ...
 */
export const createEnrollmentError = (message: string, code: keyof typeof ERROR_CODES) => {
 ...
 */
export const createProgressionError = (message: string, code: keyof typeof ERROR_CODES) => {
 ...
 */
export const createUserError = (message: string, code: keyof typeof ERROR_CODES) => {
 ...
 */
export const createCourseError = (message: string, code: keyof typeof ERROR_CODES) => {
 ...
 */
export const createContentError = (message: string, code: keyof typeof ERROR_CODES) => {
 ...
 */
export const createValidationError = (message: string, code: keyof typeof ERROR_CODES = 'VALIDATION_ERROR') => {
 ...
 */
export const createSystemError = (message: string, code: keyof typeof ERROR_CODES = 'UNKNOWN_ERROR') => {
