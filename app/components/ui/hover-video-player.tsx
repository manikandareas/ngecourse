...
const HoverVideoPlayerControls: React.FC<{ children: React.ReactNode }> = ({
  ...
  return (
    <motion.div
      ...
      className="absolute right-0 bottom-0 left-0 bg-gradient-to-t from-black to-transparent p-4"
...
const HoverVideoPaddingWrapper: React.FC<{
  ...
  return (
    ...
    >
      <div className="-inset-[var(--padding)] absolute rounded-[calc(var(--radius)+var(--padding))] shadow-sm ring-1 ring-black/5 [--padding:theme(spacing.2)]" />
      {children}
    </div>
  );
};
